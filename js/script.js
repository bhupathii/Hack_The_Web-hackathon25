...
// Remove menu mobile when clicking on links
...
// Handle window resize to close mobile menu if window becomes large
...
class HomeCarousel {
    constructor() {
        this.slides = document.querySelectorAll('.home__slide');
